        ...
        <v-card class="rounded-xl" color="#0000007D">
          ...
          <v-row class="mx-6" align="center">
            ...
            <base-body >
              ...
              <p class="text-white">Como tudo que é lúdico envolve diversão, trazemos uma proposta onde os jogos modernos (sobretudo de tabuleiro) sejam uma grata companhia dos sabores aqui encontrados.</p>
              ...
              <p class="text-white">“Abraço”. Em tempos de pandemia e suas decorrências, sabemos que a segurança e higiene são ainda mais fundamentais. Todavia, com nosso jeito de ser iremos abraçá-lo, não literalmente, mas com nossas propostas de lanches, cafés e diversão...e , para quem gosta, com algum “dedo de prosa”.</p>
            </base-body>
          </v-row>
        </v-card>
        <br/><br/><br/><br/>
